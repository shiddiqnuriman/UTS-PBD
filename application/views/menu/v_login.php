...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/img/Logo rumah.png') ?>">
...
<body>
    ...
    <form id="form" method="POST" action="<?php echo base_url('login/aksi_login') ?>">
        ...
        <img class="rounded img-fluid" id="image" style="width:auto;height:auto;margin-left:42px;" src="<?php echo base_url('assets/img/logo rumah.png') ?>">
        <div></div>
